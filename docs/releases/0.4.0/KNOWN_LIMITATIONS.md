# Elf3D 0.4.0 Known Limitations

Purpose: Record supported boundaries and known limitations for Elf3D 0.4.0.
...
- Linux and macOS are not validated for 0.4.0.
- SDK packaging is deferred; only the Windows viewer ZIP is prepared.
