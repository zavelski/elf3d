...
Purpose: Record measured and unmeasured performance status for Elf3D 0.7.1 and
...
No performance claims should be made for 0.7.1 beyond the existence of renderer,
