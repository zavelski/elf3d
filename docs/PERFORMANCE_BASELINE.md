...
Purpose: Record measured and unmeasured performance status for Elf3D 0.7.2 and
...
No performance claims should be made for 0.7.2 beyond the existence of renderer,
