...
Purpose: Record measured and unmeasured performance status for Elf3D 0.6.0 and
...
No performance claims should be made for 0.6.0 beyond the existence of renderer,
