...
Purpose: Document Elf3D 0.7.1 ownership, destruction order, cache invalidation,
...
Known limitations: The 0.7.1 runtime model is single-threaded for scene
...
0.7.1 assumes single-threaded scene mutation, navigation, picking, viewport
