...
Purpose: Document Elf3D 0.7.2 ownership, destruction order, cache invalidation,
...
Known limitations: The 0.7.2 runtime model is single-threaded for scene
...
0.7.2 assumes single-threaded scene mutation, navigation, picking, viewport
