...
Purpose: Document Elf3D 0.1.0 ownership, destruction order, cache invalidation,
...
Known limitations: The 0.1.0 runtime model is single-threaded for scene
...
0.1.0 assumes single-threaded scene mutation, navigation, picking, viewport
