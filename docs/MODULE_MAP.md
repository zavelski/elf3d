...
| `elf3d_interaction` | Static | Viewport input transition and pointer capture state for click, orbit, pan, and zoom drags. | `elf3d_math`, `elf3d_core` | none |
...
| `elf3d_graphics` | Static | Neutral device, render target, picking target, texture, mesh, pipeline interfaces. | `elf3d_clipping`, `elf3d_core` | none |
| `elf3d_backend_opengl` | Static | GLAD/OpenGL 4.1 implementation of graphics device, render targets, and integer picking targets. | `elf3d_graphics`, `elf3d_core` | `elf3d_third_party_glad` |
| `elf3d_renderer` | Static | Render-list preparation, PBR shader path, GPU picking pass, GPU caches, overlays. | `elf3d_scene`, `elf3d_clipping`, `elf3d_assets`, `elf3d_graphics`, `elf3d_math`, `elf3d_core` | none |
| `elf3d_viewport` | Static | Off-screen viewport state, render-target ownership, picking-target ownership, and tool orchestration. | tool modules, `elf3d_picking`, `elf3d_navigation`, `elf3d_interaction`, `elf3d_graphics`, `elf3d_renderer`, `elf3d_scene`, `elf3d_math`, `elf3d_core` | none |
