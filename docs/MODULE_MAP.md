...
Purpose: Record the actual Elf3D 0.7.2 CMake targets, responsibilities,
dependency direction, and C++20 named-module state.

Applicable version: 0.7.2

Document status: Living build/module map for the local 0.7.2 source.
...
The root project is `Elf3D` version `0.7.2`. It requires CMake 3.28 or newer,
