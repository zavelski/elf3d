...
int main(int argument_count, char **arguments) {
    ...
    elf3d::scene::ImportBuilder rich_builder{rich_storage};
    ...
    if (!rich_bounds.is_valid || !nearly_equal(rich_bounds.minimum.x, -2.0F) ||
        !nearly_equal(rich_bounds.minimum.y, 0.0F) || !nearly_equal(rich_bounds.maximum.x, 3.0F) ||
    ...
    elf3d::scene::ImportBuilder glb_builder{glb_storage};
    ...
    elf3d::scene::ImportBuilder disabled_builder{disabled_storage};
    ...
    elf3d::scene::ImportBuilder data_builder{data_storage};
    ...
    elf3d::scene::ImportBuilder invalid_builder{invalid_storage};
    ...
    if (elf3d::gltf::import_scene(unsupported_path, {}, invalid_builder).error().code() !=
        elf3d::ErrorCode::unsupported_primitive_mode) {
        return 26;
    }
    ...
    elf3d::scene::ImportBuilder data_image_builder{data_image_storage};
    ...
    elf3d::scene::ImportBuilder image_glb_builder{image_glb_storage};
    ...
    for (std::size_t index = 0; index < gltf_filters.size(); ++index) {
        ...
        elf3d::scene::ImportBuilder filter_builder{filter_storage};
    ...
    elf3d::scene::ImportBuilder jpeg_builder{jpeg_storage};
    ...
    elf3d::scene::ImportBuilder normalized_builder{normalized_storage};
    ...
    elf3d::scene::ImportBuilder missing_uv_builder{missing_uv_storage};
    ...
    elf3d::scene::ImportBuilder alpha_builder{alpha_storage};
    ...
    const elf3d::SceneStatistics fixture_statistics = fixture_storage.statistics();
    if (fixture_statistics.image_assets != 1 || fixture_statistics.texture_assets != 2 ||
        fixture_statistics.sampler_descriptions != 2 ||
        fixture_statistics.materials_with_base_color_textures != 2 ||
        fixture_statistics.materials_with_metallic_roughness_textures != 1) {
        return 55;
    }
