#ifndef ELF3D_SCENE_STORAGE_H
#define ELF3D_SCENE_STORAGE_H
...
struct EntityRecord {
    ...
    math::Matrix4 local_matrix{1.0F};
    mutable math::Matrix4 world_matrix{1.0F};
...
class Storage final {
  public:
    ...
    [[nodiscard]] Result<math::Matrix4> local_matrix(EntityId entity) const noexcept;
